...
class RobustMatcher {
  ...
  private:
	  ...
	  double dist; // distance to be considered inlier

  public:

	  RobustMatcher() : ratio(0.65f), dist(1.0) {//refineF(true), confidence(0.99), distance(3.0) {	  
/*
...
//		std::cout << "Number of matched points (symmetry test): " << symMatches.size() << std::endl;
		...
		cv::Mat homography= ransacTest(symMatches, keypoints1, keypoints2, matches);
